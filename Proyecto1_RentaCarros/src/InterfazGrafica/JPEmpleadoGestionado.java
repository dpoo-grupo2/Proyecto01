...
public class JPEmpleadoGestionado extends JPanel {

	private JLabel lblRelleno;
	
    public JPEmpleadoGestionado(MenuAdminSede vent) 
    {
        ...
        JLabel label = new JLabel("<html>¡Empleado eliminado/<br>añadido correctamente!</html>");
