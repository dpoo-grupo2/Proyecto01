...
Vehiculo(String placa,int anio,String color,String marca,String modelo, String transmicion, String gpsVehiculo, String estadoActual, int capacidadPersonas,
...
public String cambiarEstado(String nuevoEstado) {//nose si toca poner otro atributo que sea "tipo de usuario" para asegurarnos que solo lo puedan mod los que lo tienen permitido
